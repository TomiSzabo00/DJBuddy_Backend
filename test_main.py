...
async def test_update_user_balance_negative():
    ...
    async with AsyncClient(app=app, base_url="http://127.0.0.1") as ac:
        ...
        remove = await ac.put("/users/%s/balance/%s/remove" % (user_id, current_balance + 1))
